...
public class cableflyes extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_cableflyes);
        // Back button functionality
        ImageView whiteback = findViewById(R.id.whitebackk);
        whiteback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(cableflyes.this, chestt.class);
                startActivity(i);
                finish();
            }
        });
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.cableflyes);
