...
public class bakedcod extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_bakedcod); // Ensure that this layout file exists
        ...
        youtubeLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Define the YouTube link for the Baked Cod Recipe
                String url = "https://youtu.be/ZQW1BbcbgTg";
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(bakedcod.this, Consistent.class); // Replace Cutting.class with your actual previous activity class name if different
