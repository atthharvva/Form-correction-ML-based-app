...
public class tofu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tofu); // Make sure this layout file exists
        ...
        youtubeLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = "https://youtu.be/Ecq2svvSWXc";
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(tofu.this, Cutting.class); // Replace Bulking.class with your actual class name
